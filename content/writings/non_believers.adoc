...
Recently at work, we were discussing 401K, which is defined as personal pension fund that you can contribute to during life and use after the age of 65. 
...
Consciously or not they bet that in 40-60 years the system they live now would be basically unchanged: 
...
I think that it's valuable to map correctly scale of one's life to the history. 
...
If we are changing ourselves, how could we expect bigger systems - states, banks, culture, etc - 
